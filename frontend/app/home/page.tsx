      ...
      <div
        style={{
          ...
          background: card.poster_url
            ? `url(${card.poster_url}) center/cover no-repeat`
    ...
    >
      ...
      >
        {items.length === 0 ? (
          <div
            className="empty"
            style={{ flex: 1, minHeight: "120px", display: "flex", alignItems: "center", justifyContent: "center" }}
          >
  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <HorizontalCarousel
          title="Mais bem avaliados da semana"
          eyebrow="Top Rated"
